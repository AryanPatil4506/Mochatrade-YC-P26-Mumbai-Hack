...
"""tests/test_attacks.py — Test Suite for Attack Simulation Lab
...
from api.attack_routes import set_pipeline_runner
...
class TestAttackSimulatorEngine:
    ...
    @patch("executor.tool_registry.execute_tool")
    @patch("executor.executor.execute_request")
