// Copied verbatim from packages/contracts/ts/contracts.ts (the backend
// team's own hand-written mirror of packages/contracts/{enums,schemas}.py).
// Do not diverge from that file for the types below — if schemas.py changes,
// re-copy it here rather than hand-editing out of sync.
